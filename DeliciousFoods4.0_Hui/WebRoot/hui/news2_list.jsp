...
<link rel="stylesheet" type="text/css" href="static/h-ui.admin/css/H-ui.admin.css" ></link>
<link rel="stylesheet" type="text/css" href="lib/Hui-iconfont/1.0.8/iconfont.css" ></link>
<link rel="stylesheet" type="text/css" href="static/h-ui.admin/skin/default/skin.css" id="skin" ></link>
<link rel="stylesheet" type="text/css" href="static/h-ui.admin/css/style.css" ></link>
<!--[if IE 6]>
...
<body>
	<div id="page">
		...
		<!-- 主体 -->
		<div id=main>
			<%@ include file="../admin/shared/nav.jsp"%>
			<div id="container">
				<p style="background-color:#D9D9D9;width:100%;height:20px;"></p>
				<p style="padding-top:5px;width:100%;"></p>
